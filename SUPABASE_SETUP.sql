-- ================================================================
--  GoalGenius v6 Final — Supabase Setup
...
-- 3. PREDICTIONS (with winner_pick)
create table public.predictions (
  ...
  winner_pick  text check (winner_pick in ('home','draw','away')),
  created_at   timestamptz default now(),
...
create policy "Admins delete matches"     on public.matches     for delete using (exists(select 1 from public.profiles where id=auth.uid() and role='admin'));
